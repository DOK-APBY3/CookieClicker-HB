...
namespace CookieClicker_HB.EnemyClasses
{
    public class NinjaEnemyTemplate : EnemyTemplate
    {
        ...
        public NinjaEnemyTemplate(string name, string iconName, string iconSourse, string groupe, int baseLife, int baseGold, double lifeModifier, double goldModifier, double spawnRate, double uvoritingChanse)
